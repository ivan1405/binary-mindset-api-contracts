package com.binary.mindset.contracts.config;
...
@EnableSwagger2
@Configuration
@ComponentScan(basePackages = "com.binary.mindset.contracts")
public class Config {

    @Bean
    public Docket api() {
        final String BASE_PACKAGE = "com.binary.mindset.contracts";
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
                        .title("Api Contracts tutorial")
